...
const Experience = () => {
  ...
  return (
    <div>
      <Margin>
        <div className="flex flex-col justify-start items-center lg:gap-y-20 pt-20 px-10 md:px-16 lg:px-0 h-full">
          <div className="lg:sticky top-0 w-full z-40 lg:block hidden">
          ...
          <h1 className="lg:hidden font-extrabold text-3xl lg:text-5xl text-wrap text-center z-50 relative">
            WORK EXPERIENCE
          </h1>
          <motion.div
            className="flex justify-center flex-col items-center gap-16 lg:py-2 w-full"
